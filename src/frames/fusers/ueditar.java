 ...
 * @author Estevane
 */
public class ueditar extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ueditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
